...
WAF.define('waf-core/event', function() {
     ...
     * @param {Event} [parent_event] - Parent event, if the event is refired
     ...
     */
    Event.All.prototype.initialize = function(parent_event, target, data, emitter) {
        // parent_event is optional
        if(!Class.instanceOf(parent_event, Event.All)) {
            emitter = data;
            data = target;
            target = parent_event;
            parent_event = undefined;
        }
        // target is optional
        ...
        if(parent_event)
            this.emitters = parent_event.emitters.slice(0);
        /**
         * Data of the event
         * @type {object}
         */
