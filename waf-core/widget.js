...
WAF.define('waf-core/widget', function() {
    ...
    exports.create = function createWidget(name, base, proto) {
         ...
         * @instance
         */
        _class.addMultiInheritedCaller('_initChildrenFromDom');
        /**
         ...
         * @instance
         */
        _class.addMultiInheritedCaller('_createChildren');
        ...
        _class.inherit = function() {
            var args = [].map.call(arguments, function(arg) {
                return typeof arg === 'string' ? WAF.require(arg) : arg;
            });
            var _class = this;
    ...
    exports.instanceFromDom = function instanceWidgetFromDom(node) {
        ...
        } else if ($(node).find('[data-type][data-package]').length) {
