...
module.exports = (function(){
    ...
    buildHelper = {
        ...
        createWcMainJs : function(componentSourceFile) {
            ...
            codeWidgetClass += "        }\r\n\t";
            codeWidgetClass += "    }\r\n\t";
            codeWidgetClass += "    if (this.widgets) {\r\n\t";
            codeWidgetClass += "      for (wigdetName in this.widgets) { \r\n\t";
            codeWidgetClass += "          if($$(this.id + '_' + wigdetName)) {$$(this.id + '_' + wigdetName).destroy();}\r\n\t";
            codeWidgetClass += "          } \r\n\t";
            codeWidgetClass += "     }\r\n\t";
            ...
            codeWidgetClass += "            }\r\n\t";
            codeWidgetClass += "            delete WAF.widgets[children.id];\r\n\t";
            codeWidgetClass += "        }\r\n\t";
            codeWidgetClass += "    }\r\n\t";
            ...
            codeWidgetClass += "    }\r\n\t";
            codeWidgetClass += "    this.$domNode.children().remove();\r\n\t";
            codeWidgetClass += "    this.$domNode.css('visibility', 'hidden');\r\n\t";
            codeWidgetClass += "if ($('#waf-component-fade')) {\r\n\t";
            codeWidgetClass += "$('#waf-component-fade').fadeOut(function() {\r\n\t";
                                    ...
                                    if(buildList[type][i].changed === true || !buildsFromStorage["/"+buildList[type][i].path+"/"+buildList[type][i].file]){
                                        ...
                                        if(buildList[type][i].wcKey){
                                            ...
                                            if(buildList[type][i].wcMainJs){
                                                ...
                                                tempOutput = minifier(tempFile,fileHelper.getHttpPath(buildList[type][i].file,buildList[type][i].path),true,doNotMinify,specifyTimestamp);
