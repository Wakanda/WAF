...
builderHandlerTests['min'] = function (request,response){
    ...
    output += "\n\nModuleBuildMin.makeMinFiles('minifyCores') = "+ModuleBuildMin.makeMinFiles("minifyCores", doNotMinify);
...
builderHandlerTests['mincores'] = function (request,response){
    ...
    output += "\n\nModuleBuildCores.makeMinCoresFiles(doNotMinify,dev) = "+ModuleBuildCores.makeMinCoresFiles(doNotMinify,dev);
...
builderHandlerTests['getPackage'] = function (request, response){
    ...
    output += "=== fileHelper.getFileContent('"+packageJsonUrlPath+"') ("+(new Date()).toUTCString()+")===\n";
    output += fileHelper.getFileContent(packageJsonUrlPath);
