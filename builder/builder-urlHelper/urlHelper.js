...
module.exports = (function(){
    ...
    UrlHelper = {
        ...
        getInfos: function(request){
            ...
            var urlPath, referer, contentType, type, debug = false, packageJsonUrlPath, pattern, i, useReferer, path;
            ...
            //if called directly (such as toto.waPage/toto.package.json~waf-build.js?path=toto.waPage/index.html ) for test purpose
            if(!referer){
                //test for debug mode
