WAF.define('waf-behavior/position', function() {
    ...
    proto.absolutePosition = function() {
        var ab = this.parent_widget.absolutePosition();
        var p = this.position();
        var s = this.parent_widget.contentOffset ? this.parent_widget.contentOffset() : { x: 0, y: 0 };
        return {
    ...
    klass.options_parsers['constraint-left'] = // FIXME: find a way to prevent the parsers to be launched many times...
    klass.options_parsers['constraint-right'] = 
    klass.options_parsers['constraint-top'] = 
    klass.options_parsers['constraint-bottom'] = function() {
        var c = {},
        that = this;
    ...
    klass.options_parsers.draggable = function() {
