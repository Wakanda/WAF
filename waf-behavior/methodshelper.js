...
WAF.define('waf-behavior/methodshelper', function() {
     ...
     */
    var MethodsHelper = Behavior.create('MethodsHelper');
     ...
     * @memberof MethodsHelper
     * @method addMultiInheritedCaller
     */
    MethodsHelper.addMultiInheritedCaller = function(name) {
        var klass = this;
        this.prototype[name] = function() {
            if(!klass.supers) return;
     ...
     * @param {function} callback - The function to call before
     * @memberof MethodsHelper
     * @method doBeforeClassMehod
     */
    MethodsHelper.doBeforeClassMehod = function(name, callback) {
    ...
    Class.default_behaviors.push(MethodsHelper);
