WAF.define('waf-behavior/size', function() {
    ...
    // klass.addProperty('min-width',  { onChange: function() { klass.optionsParsers.resizable.call(this, this._resizable); } });
    // klass.addProperty('max-width',  { onChange: function() { klass.optionsParsers.resizable.call(this, this._resizable); } });
    // klass.addProperty('min-height', { onChange: function() { klass.optionsParsers.resizable.call(this, this._resizable); } });
    // klass.addProperty('max-height', { onChange: function() { klass.optionsParsers.resizable.call(this, this._resizable); } });
