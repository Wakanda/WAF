WAF.define('waf-behavior/style', function() {
     ...
     * @memberof Style
     * @method addClassOption
     * @public
     */
    klass.addClassOption = function(optionName, values, _default) {
        // add support for a new option that directly transform into a class
        var o = this._optionsClasses[optionName] = {
            values: values,
            'default': _default
        };
        if (arguments.length > 2) {
            this.defaultOptions[optionName] = _default;
        }
        this.optionsParsers[optionName] = function() {
            Object.values(o.values).forEach(function(c) {
                this.removeClass(c);
            }.bind(this));
            this.addClass(o.values[this.options[optionName]] || o.values[o['default']]);
        };
    };
    ...
    if ('waf-behavior/bindable' in WAF.require.modules) {
        ...
        proto.bindDatasourceAttributeCSS = function(datasource, attribute, cssProperty) {
            ...
            var subscriber = this._bindedCssAttributes[cssProperty] = this.bindDatasourceAttributeWithCallback(datasource, attribute, function(value) {
