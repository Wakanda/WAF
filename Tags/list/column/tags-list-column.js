 ...
 * @method toArray
 */
WAF.tags.list.Column.prototype.toArray = function(sizeMax) {
    var length = this.count(),
    attributeLength = 0,
    attributeName = '',
    i = 0,
    ...
    column = null,
    result = [],
    restrictColumn = false,
    lastColumn = {'sourceAttID': 'lastColumn', 'colID': 'lastColumn', 'width': '70', 'title': '......'},
    columnProp = {};
    ...
    if (restrictColumn && sizeMax < this.count()) {
