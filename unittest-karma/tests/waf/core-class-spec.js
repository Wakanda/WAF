...
describe('Class', function() {
    ...
    describe('#inherit()', function() {
        it('should return the class', function() {
            var a = Class.create();
            var b = Class.create();
            expect(a.inherit(b)).to.equal(a);
            expect(a).to.be.an.inheritFromClass(b);
        });
        it('should support packages', function() {
            var a = Class.create();
            WAF.define('toto', function() { return Class.create(); });
            expect(a.inherit('toto')).to.equal(a);
            expect(a).to.be.an.inheritFromClass('toto');
        });
        it('should support 0 arguments', function() {
            var a = Class.create();
            expect(a.inherit()).to.equal(a);
        });
        ...
        it('should throw an error if no package', function() {
            var a = Class.create();
            expect(function() {
                a.inherit('unknown package');
            }).to.throw(WakError);
        });
    });
    describe('#inherit() instance methods', function() {
        ...
        it('should return undefined for unknown $super', function() {
            var a = Class.create();
            a.prototype.initialize = function() {
                expect(this.$super('plop')).to.be.undefined;
            };
            var _a = new a();
        });
        it('should return the super of a given class', function() {
            var b = Class.create();
            b.prototype.plop = function(_a) {
                expect(this).to.equal(_a);
            };
            sinon.spy(b.prototype, 'plop');
            var a = Class.create();
            a.prototype.initialize = function() {
                this.$super('plop', b)(this)
            };
            var _a = new a();
            expect(b.prototype.plop).to.have.been.called;
        });
        it('should restore $super even if the function throw', function() {
            var b = Class.create();
            b.prototype.plop = function() {
                throw new Error();
            };
            var a = Class.create()
            a.inherit(b);
            a.prototype.plop = function() {
                this.$super('plop')();
            };
            var _a = new a();
            expect(function() { _a.plop(); }).to.throw();
            expect(_a.$super('plop')).to.not.be.undefined;
            expect(function() { _a.plop(); }).to.throw();
            expect(_a.$super('plop')).to.not.be.undefined;
            expect(function() { _a.plop(); }).to.throw();
            expect(_a.$super('plop')).to.not.be.undefined;
    ...
    describe('#inherit() class attributes', function() {
        ...
        it('Should call whenInherited()', function() {
            var a = Class.create();
            var b = Class.create();
            b.whenInherited = function(klass) {
                expect(this).to.equal(b);
            };
            sinon.spy(b, 'whenInherited');
            a.inherit(b);
            expect(b.whenInherited).to.have.been.calledWith(a);
        });
    });
    ...
    describe('#getAllSupers()', function() {
        it('should return inherited supers', function() {
            ...
            expect(f.getAllSupers()).to.have.length(3 + Class.defaultBehaviors.length);
        });
    ...
    describe('.defaultBehaviors', function() {
        var b = Class.create('b');
        Class.defaultBehaviors.push(b);
        var a = Class.create('a');
