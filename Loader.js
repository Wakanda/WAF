        ...
        modulesInfo: {
            ...
            'allmodules': {
                ...
                require: [
                    ...
                    '+/waf-behavior/propertieshelper.js',
                    '+/waf-core/subscriber.js',
                    '+/waf-behavior/observable.js',
                    //'+/waf-behavior/domobservable.js',
                    //'+/waf-core/widget.js',
                    //'+/waf-behavior/bindable.js',
                    //'+/waf-behavior/focus.js',
                    //'+/waf-behavior/style.js',
                    //'+/waf-behavior/size.js',
                    //'+/waf-behavior/position.js',
                    //'+/waf-behavior/listable.js',
                    //'+/waf-behavior/layout/composed.js',
                    //'+/waf-behavior/layout/container.js',
                    //'+/waf-behavior/layout/multicontainer.js',
                    //'+/waf-widget/body.js',
                    //'+/waf-widget/text.js',
                    //'+/waf-widget/input.js',
                    //'+/waf-widget/button.js',
                    //'+/waf-widget/container.js',
                    //'+/waf-widget/repeater.js',
                    //'+/waf-widget/menu.js',
                    //'+/waf-widget/tabview.js',
                    //'+/waf-widget/combobox.js',
            ...
            function loadCatalog() {
                ...
                var onCatalogLoad = function(event) {
                    ...
                    if (typeof (WAF.tags) !== 'undefined') {
                        ...
                        if (WAF.require.modules['waf-core/widget']) {
                            var Body = WAF.require('waf-widget/body');
                            WAF.require('waf-core/widget').body = new Body(document.body);
                        }
