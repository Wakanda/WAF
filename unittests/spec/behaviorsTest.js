...
describe('Behavior.PropertiesHelper', function() {
    describe('.addProperty', function() {
        ...
        it('should use the getter', function() {
            a.addProperty('toto', undefined, function(name) { return name == 'toto' });
            var _a = new a();
            _a.toto(123);
            expect(_a.toto()).to.be.true;
        });

        it('should use the setter', function() {
            var ok;
            a.addProperty('toto', undefined, undefined, function(value, name) { if(name == 'toto') { ok = value; } });
            var _a = new a();
            _a.toto(123);
            expect(_a.toto()).to.equal(123);
            expect(ok).to.equal(123);
        });
